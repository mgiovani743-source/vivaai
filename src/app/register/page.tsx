...
import { sanitizeUserInput } from '@/lib/security/privacy';
...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const cleanName = sanitizeUserInput(name.trim());
    ...
    // Supabase pode exigir confirmação de e-mail dependendo da configuração
    // Se Email Confirmations estiver desabilitado no Supabase, o usuário já estará logado
    setSuccess(true);
    ...
    return (
      <main className="relative flex min-h-screen items-center justify-center px-4 py-12">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-viva-graphite mb-2">Conta criada!</h1>
          <p className="text-viva-gray text-sm">Redirecionando para o dashboard...</p>
        </motion.div>
      </main>
    );
  }
