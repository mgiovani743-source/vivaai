...
export default function AdminPage() {
  ...
  // V1: Salva produtos apenas na memória local.
  // Escrita real no Supabase (products table) via Server Action com role admin na V2.
  // Esta rota é protegida pelo middleware via ADMIN_EMAILS (server-side only).
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Painel de administração — acesso via ADMIN_EMAILS
              </p>
            </div>
          </div>
          <a
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-sm text-amber-800">
          <strong>Versão 1 — Modo local:</strong> Produtos adicionados aqui ficam na memória da sessão.
          Na V2, a escrita será feita via Server Action com role admin no Supabase.
          O acesso a esta página é restrito por ADMIN_EMAILS no middleware.
        </div>
